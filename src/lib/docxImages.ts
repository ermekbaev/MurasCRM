 ...
 * stamp или signature. При выгрузке мы находим её по этой пометке и заменяем
 * на печать или подпись из настроек компании — либо на прозрачный пиксель,
...
export type ImageSlot = "stamp" | "signature";
