 ...
 *
 * Поэтому тон нейтралей поворачиваем к фирменному, а светлоту оставляем как
 * есть. Насыщенность при этом приходится убавлять: одна и та же цифра на
 * тёплом тоне читается куда сильнее, чем на холодном. Оставив её как в синей
 * палитре, получаем не тёплый серый, а жёлто-красный фон — проверено на
