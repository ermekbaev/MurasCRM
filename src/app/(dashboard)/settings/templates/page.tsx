        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          {form.kind === "DOCX" && (
            <div className="space-y-2 rounded-lg border border-line bg-surface-sunken p-3">
              ...
              <p className="text-xs text-fg-subtle">
                Для логотипа, печати и подписи вставьте в бланк картинку-заглушку и в её
                «Замещающем тексте» напишите logo, stamp или signature. При выгрузке
                система подставит туда картинку из настроек компании. Логотип ставится
                всегда, печать и подпись — по галке при выгрузке. Форматы должны совпадать:
                заглушка PNG — и печать PNG.
              </p>
              <input
                type="file"
                accept=".docx"
