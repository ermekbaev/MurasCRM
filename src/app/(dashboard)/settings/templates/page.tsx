        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          {form.kind === "DOCX" && (
            <div className="space-y-2 rounded-lg border border-line bg-surface-sunken p-3">
              ...
              <p className="text-xs text-fg-subtle">
                Для печати и подписи вставьте в бланк любую картинку-заглушку и в её
                «Замещающем тексте» напишите stamp или signature. При выгрузке
                система подставит туда печать и подпись из настроек компании —
                либо уберёт их, если выгружать без них. Форматы должны совпадать:
