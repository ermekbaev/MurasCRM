      ...
      <Card padding="md">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="min-w-0">
            ...
            {/* Рядом стоит «Сформировать счёт», и кнопки легко перепутать:
                заказчик так и сделал. Говорим прямо, что получится файл, а не
                запись в разделе «Счета». */}
            <p className="mt-1 text-xs text-fg-subtle">
              Получится файл: его можно скачать и приложить к заявке. Отдельный счёт
              в разделе «Счета» при этом не появляется — для него кнопка выше.
            </p>
          </div>
